...
export const routingComponents = [MainComponent, AboutComponent, ResourceComponent, ResourcesComponent, CreateProfileComponent, LoginProfileComponent, UserProfileComponent];
